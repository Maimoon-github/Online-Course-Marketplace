      ...
      <div className="max-w-6xl w-full grid lg:grid-cols-2 gap-8 items-center">
        ...
        >
          <div className="relative">
            {/* 3D-ish decorative element */}
            <div className="absolute -top-20 -left-20 size-64 bg-[#4A90E2]/10 rounded-full blur-3xl" />
            <div className="absolute -bottom-20 -right-20 size-64 bg-[#3B8075]/10 rounded-full blur-3xl" />
            
            <div className="relative">
              <div className="flex items-center gap-3 mb-8">
                <div className="relative">
                  <div className="absolute inset-0 bg-[#4A90E2] blur-xl opacity-50 rounded-full" />
                  <GraduationCap className="size-12 text-[#4A90E2] relative" />
                </div>
                <span className="text-2xl font-bold text-[#E5E7EB]">LearnFlow</span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                {[
                  ...
                  { value: '15K+', label: 'Instructors' },
                ].map((stat, index) => (
                  <div key={index} className="text-center">
                    <div className="text-2xl font-bold text-[#E5E7EB] mb-1">{stat.value}</div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={index} className="flex items-center gap-3">
                    <div className="size-6 rounded-full bg-[#3B8075]/20 flex items-center justify-center">
                      <ArrowRight className="size-3 text-[#3B8075]" />
                    </div>
        ...
        >
          <div className="bg-[#1F2937] rounded-2xl p-8 border border-white/5">
            ...
            <div className="lg:hidden flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-bold text-[#E5E7EB]">LearnFlow</span>
            </div>

            {/* Tabs */}
            <div className="flex gap-2 p-1 bg-[#16213E] rounded-lg mb-8">
              <button
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <Mail className="absolute left-3 top-1/2 -translate-y-1/2 size-5 text-[#9CA3AF]" />
                  <Input
                    type="email"
              ...
              <div>
                ...
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 size-5 text-[#9CA3AF]" />
                  <Input
                    type={showPassword ? 'text' : 'password'}
                    placeholder="••••••••"
                    value={formData.password}
                    onChange={(e) => setFormData({ ...formData, password: e.target.value })}
                    className="pl-10 pr-10 bg-[#16213E] border-white/10 text-[#E5E7EB] placeholder:text-[#9CA3AF] focus:border-[#4A90E2] focus:ring-[#4A90E2]/20"
                  />
                  <button
                    type="button"
              ...
              {isLogin && (
                <div className="flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    className="text-sm text-[#4A90E2] hover:text-[#4A90E2]/80"
                  >
                    Forgot password?
                  </button>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button
                  type="button"
                  variant="outline"
                  className="border-white/10 text-[#E5E7EB] hover:bg-[#16213E]"
                >
